...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="span6">
	  ...
	  $this->db->trans_start();
	  $this->db->update('TDC_SHOPINFO',$data,$where);
	 ...
	 // echo $this->db->trans_status();
	  ...
	  ?>
		  ...
		  <?php
				...
				$query = $this->db->query("SELECT * FROM  tdc_shopinfo where TDC_ShopID=$shopid");
				$row = $query->row();
		  ...
		  ?>
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11"  name="sellerName" value="<?php echo $row->TDC_SellerName?>"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">联系人：</label>
              <div class="controls">
                <input type="text" class="span11"  name="contactPerson" value="<?php echo $row->TDC_ShopContactPerson?>"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">联系电话</label>
              <div class="controls">
                <input type="text"  class="span11" name="phoneNo" value="<?php echo $row->TDC_ShopPhoneNo?>"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">邮箱</label>
              <div class="controls">
                <input type="text" class="span11"  name="email" value="<?php echo $row->TDC_ShopEmail?>"/>
              </div>
            </div>
