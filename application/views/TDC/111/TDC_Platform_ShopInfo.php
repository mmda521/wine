            ...
            <table class="table table-bordered data-table">
              ...
              <?php
				 ...
				 foreach ($query->result_array() as $row)
				{
					...
					"
					<tr class=\"gradeA\">
						<td width=\"20%\">".$row['TDC_SellerName']."</td>
						<td width=\"20%\">".$row['TDC_ShopContactPerson']."</td>
						<td width=\"20%\">".$row['TDC_ShopPhoneNo']."</td>
						<td width=\"20%\">".$row['TDC_ShopEmail']."</td>
						<td width=\"20%\"><a href=\"TDC_Platform_ShopUpdate?shopid=".$row['TDC_ShopID']."\"  style=\"color:blue\">编辑</a>  
						 <a href=\"TDC_Platform_ShopDel?shopid=".$row['TDC_ShopID']."\"  style=\"color:blue\" onclick=\"javascript:if(confirm('确定要删除此信息吗？')){alert('删除成功！');return true;}return false;\">删除</a>
						 </td>	
					</tr>
						";
