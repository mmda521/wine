...
<link rel="stylesheet" href="<?php echo base_url(); ?>webroot/TDC_Platform/css/jquery.gritter.css" />
        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <ul class="quick-actions">
              <li class="bg_lb"> <a href="<?php echo site_url("Qr_Code/qr_add");?>"> <i class="icon-book"></i> 二维码生成 </a> </li>
              <li class="bg_lg"> <a href="<?php echo site_url("Qr_Code/qr_active");?>"> <i class="icon-tasks"></i> 二维码激活</a> </li>
              <li class="bg_ly"> <a href="<?php echo site_url("Qr_Code/search_active");?>"> <i class="icon-calendar"></i> 二维码查询 </a> </li>

              <li class="bg_lo"> <a href="<?php echo site_url('Goods/GoodsInfo');?>"> <i class="icon-user"></i>一般贸易商品</a> </li>
              <li class="bg_ls"> <a href="<?php echo site_url('Goods/Waiting');?>"> <i class="icon-upload-alt"></i>跨境集货商品</a> </li>
              <li class="bg_lb"> <a href="<?php echo site_url('Goods/Waiting');?>"> <i class="icon-download"></i>跨境备货商品</a> </li>
              <br>
              <br>
              <br>
              <br>
              <!--
              <li class="bg_lg"> <a href="#"> <i class="icon-bar-chart"></i>商家信息总览</a> </li>
...
<script src="<?php echo base_url(); ?>webroot/TDC_Platform/js/jquery.gritter.min.js"></script> 
...
<script src="<?php echo base_url(); ?>webroot/TDC_Platform/js/matrix.popover.js"></script>
</body>
</html>
