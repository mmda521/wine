    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="<?php echo site_url('Origin/do_OriginUpdate');?>" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11"  name="originName" value="<?php echo $info['TDC_OriginName']?>"/>
                 <input type="hidden" class="span11"  name="originid" value="<?php echo $info['TDC_OriginID']?>"/>
              </div>
            </div>
